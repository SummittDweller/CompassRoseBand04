...
$art_style = '';
$art_head = '';
function CompassRoseBand04_process_html(&$variables) {
...
function CompassRoseBand04_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function CompassRoseBand04_button($variables) {
 ...
 */
function CompassRoseBand04_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function CompassRoseBand04_menu_local_task($variables) {
 ...
 */
function CompassRoseBand04_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function CompassRoseBand04_node_preview($variables) {
  $node = $variables['node'];
...
*/
function CompassRoseBand04_form_alter(&$form, &$form_state, $form_id) {
...
function CompassRoseBand04_form_element_label($variables) {
...
function CompassRoseBand04_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function CompassRoseBand04_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
